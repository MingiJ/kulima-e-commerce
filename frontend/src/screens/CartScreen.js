...
export default function CartScreen(props) {
  ...
  return (
    ...
    <section class="cart flex">
      ...
      {cartItems.length===0 && <h1>Cart is empty.<Link to="/">Go Shopping</Link></h1>}
              {cartItems && cartItems.map(item =><CartCard removeFromCartHandler={removeFromCartHandler} item={item}/>)}
